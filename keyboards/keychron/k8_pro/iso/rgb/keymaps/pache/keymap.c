...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    [L_EXT] = LAYOUT_tkl_iso(
        ...
        // | CAPSLCK    | Q      | S      | D      | F      | G      | H      | J      | K      | L      | M      | ù%     | *µ     | RETURN      |
            MO(L_NAV),   _______, _______ /* LT(L_NAV, KC_S) */,
                                           _______, _______, _______, _______, _______, _______, _______, _______, TG(L_NAV),KC_ENT, _______,
        // |--------------------------------------------------------------------------------------------------------------------------------------|           |--------|
        // | LSHIFT   | <> | W      | X      | C      | V      | B      | N      | ,?     | ;.     | :/     | !§     | RSHIFT                     |           | UP     |
    ...
    [L_NAV] = LAYOUT_tkl_iso(
        ...
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | TAB       | A      | Z      | E      | R      | T      | Y      | U      | I      | O      | P      | ^¨     | $£     | RETURN       |  | DEL    | END    | PGDN   |
            _______,    KC_NO,   KC_LSFT, KC_LCTL, KC_LALT, KC_NO,   KC_INS,  KC_HOME, KC_UP,   KC_END,  KC_NO,   KC_NO,   KC_NO,                     _______, _______, _______,
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | CAPSLCK    | Q      | S      | D      | F      | G      | H      | J      | K      | L      | M      | ù%     | *µ     | RETURN      |
            KC_NO,       KC_CAPS, KC_LSFT, KC_LCTL, KC_LALT, KC_NO,   KC_BSPC, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL,  _______, _______, _______,
        // |--------------------------------------------------------------------------------------------------------------------------------------|           |--------|
        // | LSHIFT   | <> | W      | X      | C      | V      | B      | N      | ,?     | ;.     | :/     | !§     | RSHIFT                     |           | UP     |
            _______,KC_NO,  KC_NO,   KC_LSFT, KC_LCTL, KC_LALT, KC_NO,   KC_NO,   KC_BSPC, KC_ENT,  KC_DEL,  KC_NO,   _______,                                 _______,
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | LCTRL    | LCMD     | LALT     | SPACE                                                   | RALT     | RCMD     | FN       | RCTRL    |  | LFT    | DWN    | RGT    |
