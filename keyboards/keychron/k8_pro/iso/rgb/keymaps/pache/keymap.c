...
enum layer_names {
    ...
    L_NUM,
    // No navigation
    // Standard navigation keys disabled
    L_NONAV,
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    [L_EXT] = LAYOUT_tkl_iso(
        ...
        // | ESC    |        | F1     | F2     | F3     | F4     |    | F5     | F6     | F7     | F8     |   | F9     | F10    | F11    | F12    |  | PSCR   | CORT   | RGB    |
            _______,          _______, _______, _______, _______,      _______, _______, _______, _______,     _______, _______, _______, _______,    RGB_TOG, TG(L_NONAV),TO(L_EXT),
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | ^2     | &1     | é2~    | "3#    | '4{    | (5[    | -6|    | è7`    | _8\    | ç9^    | à0@    | )°]    | =+}    | BACKSP          |  | INS    | HOME   | PGUP   |
        ...
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | LCTRL    | LCMD     | LALT     | SPACE                                                   | RALT     | RCMD     | FN       | RCTRL    |  | LFT    | DWN    | RGT    |
            _______,   _______,   _______,   LT(L_SYM, KC_SPC),                                        KC_LCTL,   TG(L_NAV), TG(L_NAV), _______,      _______, _______, _______
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    ),
    ...
    [L_NAV] = LAYOUT_tkl_iso(
        ...
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | TAB        | A      | Z      | E      | R      | T      | Y      | U      | I      | O      | P      | ^¨     | $£     | RETURN      |  | DEL    | END    | PGDN   |
            _______,     KC_NO,   KC_LSFT, KC_NO,   KC_CAPS,   KC_NO,   KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_NO,   _______, _______,                  _______, _______, _______,
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | CAPSLCK      | Q      | S      | D      | F      | G      | H      | J      | K      | L      | M      | ù%     | *µ     | RETURN    |
            KC_NO,         KC_NO,   KC_NO,   KC_LSFT, KC_INS,  KC_NO,   KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO,   _______, _______, _______,
        // |--------------------------------------------------------------------------------------------------------------------------------------|           |--------|
        // | LSHIFT   | <>     | W      | X      | C      | V      | B      | N      | ,?     | ;.     | :/     | !§     | RSHIFT                 |           | UP     |
            _______,   _______, KC_NO,   _______, _______, _______, KC_NO,   KC_ESC,  KC_BSPC, KC_ENT,  KC_DEL,  KC_NO,   _______,                             _______,
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | LCTRL    | LCMD     | LALT     | SPACE                                                   | RALT     | RCMD     | FN       | RCTRL    |  | LFT    | DWN    | RGT    |
