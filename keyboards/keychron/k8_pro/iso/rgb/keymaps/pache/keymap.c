...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    [L_NAV] = LAYOUT_tkl_iso(
        ...
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | TAB       | A      | Z      | E      | R      | T      | Y      | U      | I      | O      | P      | ^¨     | $£     | RETURN       |  | DEL    | END    | PGDN   |
            _______,    KC_NO,   KC_LSFT, KC_LSFT, KC_NO,   KC_NO,   KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_NO,   _______, _______,                   _______, _______, _______,
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | CAPSLCK    | Q      | S      | D      | F      | G      | H      | J      | K      | L      | M      | ù%     | *µ     | RETURN      |
            KC_NO,       KC_NO,   KC_LSFT, KC_LSFT, KC_INS,  KC_NO,   KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO,  _______, _______, _______,
        // |--------------------------------------------------------------------------------------------------------------------------------------|           |--------|
        // | LSHIFT   | <> | W      | X      | C      | V      | B      | N      | ,?     | ;.     | :/     | !§     | RSHIFT                     |           | UP     |
            _______,_______,KC_NO,   KC_CAPS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   _______,                                 _______,
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | LCTRL    | LCMD     | LALT     | SPACE                                                   | RALT     | RCMD     | FN       | RCTRL    |  | LFT    | DWN    | RGT    |
