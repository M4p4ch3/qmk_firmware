...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [L_STD] = {
        ...
        {   KC_NO,       FR_Q,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    FR_M,    FR_UGRV, KC_L_(KC_ENT),            KC_NO,   KC_NO,   KC_NO   },
        // |--------------------------------------------------------------------------------------------------------------------------------------|           |--------|
    ...
    [L_EXT] = {
        ...
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | TAB       | A      | Z      | E      | R      | T      | Y      | U      | I      | O      | P      | ^¨     | $£     | *µ           |  | DEL    | END    | PGDN   |
        {   _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_ENT,           _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | CAPSLCK    | Q      | S      | D      | F      | G      | H      | J      | K      | L      | M      | ù%     | RETURN               |
        {   MO(L_NAV),   _______, _______ /* LT(L_NAV, KC_S) */,
                                           _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_2TR,                   _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------|           |--------|
        // | LSHIFT        | W      | X      | C      | V      | B      | N      | ,?     | ;.     | :/     | !§     | RSHIFT                     |           | UP     |
        {   KC_T_(MT(MOD_LSFT, FR_LABK)),
                            _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_2TR,                         _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | LCTRL    | LCMD     | LALT     | SPACE                                                   | RALT     | RCMD     | FN       | RCTRL    |  | LFT    | DWN    | RGT    |
        {   _______,   _______,   ALT_T(FR_UNDS),
                                             K_SPC(LT(L_SYM, KC_SPC)),                                 _______,   _______,   TG(L_NAV), _______,      _______, _______, _______ }
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    },
    ...
    [L_SYM] = {
        ...
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | TAB       | A      | Z      | E      | R      | T      | Y      | U      | I      | O      | P      | ^¨     | $£     | *µ           |  | DEL    | END    | PGDN   |
        {   _______,    FR_LABK, KCC_CBR, KCC_SBR, KCC_BR,  KCC_QTDQ,FR_GRV,  KCC_MNPL,KCC_EQEQ,KCC_MLDV,KCC_BSMD,KC_DCIR, _______, _______,          _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | CAPSLCK    | Q      | S      | D      | F      | G      | H      | J      | K      | L      | M      | ù%     | RETURN               |
        {   MO(L_NUM),   FR_1,    FR_2,    FR_3,    FR_4,    FR_5,    FR_6,    FR_7,    FR_8,    FR_9,    FR_0,    FR_DLR,  KC_2TR,                   _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------|           |--------|
        // | LSHIFT        | W      | X      | C      | V      | B      | N      | ,?     | ;.     | :/     | !§     | RSHIFT                     |           | UP     |
        {   KC_2TR,         FR_LABK, FR_HASH, FR_TILD, KCC_APPP,FR_RABK, FR_UNDS, _______, FR_DOT,  FR_AT,   _______, KC_2TR,                         _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | LCTRL    | LCMD     | LALT     | SPACE                                                   | RALT     | RCMD     | FN       | RCTRL    |  | LFT    | DWN    | RGT    |
    ...
    [L_NAV] = {
        ...
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | TAB       | A      | Z      | E      | R      | T      | Y      | U      | I      | O      | P      | ^¨     | $£     | *µ           |  | DEL    | END    | PGDN   |
        {   _______,    _______, _______, KC_LSFT, _______, _______, KC_INS,  KC_HOME, KC_UP,   KC_END,  _______, _______, _______, _______,          _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | CAPSLCK    | Q      | S      | D      | F      | G      | H      | J      | K      | L      | M      | ù%     | RETURN               |
        {   KC_NO,       _______, _______, KC_LCTL, KC_LALT, _______, KC_BSPC, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL,  _______, KC_2TR,                   _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------|           |--------|
        // | LSHIFT        | W      | X      | C      | V      | B      | N      | ,?     | ;.     | :/     | !§     | RSHIFT                     |           | UP     |
        {   KC_2TR,         _______, _______, _______, _______, _______, _______, KC_BSPC, KC_ENT,  KC_DEL,  _______, KC_2TR,                         _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | LCTRL    | LCMD     | LALT     | SPACE                                                   | RALT     | RCMD     | FN       | RCTRL    |  | LFT    | DWN    | RGT    |
    ...
    [L_NUM] = {
        ...
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | TAB       | A      | Z      | E      | R      | T      | Y      | U      | I      | O      | P      | ^¨     | $£     | *µ           |  | DEL    | END    | PGDN   |
        {   _______,    _______, _______, _______, _______, _______, KCC_MLDV,FR_7,    FR_8,    FR_9,    _______, _______, _______, _______,          _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | CAPSLCK    | Q      | S      | D      | F      | G      | H      | J      | K      | L      | M      | ù%     | RETURN               |
        {   KC_NO,       _______, _______, _______, _______, _______, KCC_PLMN,FR_4,    FR_5,    FR_6,    KCC_EQEQ,_______, KC_2TR,                   _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------|           |--------|
        // | LSHIFT        | W      | X      | C      | V      | B      | N      | ,?     | ;.     | :/     | !§     | RSHIFT                     |           | UP     |
        {   KC_2TR,         _______, _______, _______, _______, _______, FR_0,    FR_1,    FR_2,    FR_3,    FR_DOT,  KC_2TR,                         _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | LCTRL    | LCMD     | LALT     | SPACE                                                   | RALT     | RCMD     | FN       | RCTRL    |  | LFT    | DWN    | RGT    |
