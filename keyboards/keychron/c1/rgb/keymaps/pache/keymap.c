...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_EXT] = {
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | ESC    |        | F1     | F2     | F3     | F4     |    | F5     | F6     | F7     | F8     |   | F9     | F10    | F11    | F12    |  | PSCR   | CORT   | RGB    |
        {   _______,          _______, _______, _______, _______,      _______, _______, _______, _______,     _______, _______, _______, KC_2TR,     RGB_TOG, RGB_TOG, RGB_TOG },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | ^2     | &1     | é2~    | "3#    | '4{    | (5[    | -6|    | è7`    | _8\    | ç9^    | à0@    | )°]    | =+}    | BACKSP          |  | INS    | HOME   | PGUP   |
    ...
    [L_SYM_SFT] = {
        ...
        // |--------------------------------------------------------------------------------------------------------------------------------------|           |--------|
        // | LSHIFT            | W      | X      | C      | V      | B      | N      | ,?     | ;.     | :/     | !§     | RSHIFT                 |           | UP     |
        {   KC_T_(KC_NO),       _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_L_(KC_NO),               _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | LCTRL    | LCMD     | LALT     | SPACE                                                   | RALT     | RCMD     | FN       | RCTRL    |  | LFT    | DWN    | RGT    |
        {   _______,   _______,   _______,   K_SPC(KC_NO),                                             _______,   _______,   _______,   _______,      _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    ...
    [L_NUM] = {
        ...
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | CAPSLCK      | Q      | S      | D      | F      | G      | H      | J      | K      | L      | M      | ù%     | RETURN             |
        {   KC_NO,         KC_NO,   KC_NO,   FR_MINS, FR_PLUS, KC_NO,   KC_NO,   FR_4,    FR_5,    FR_6,    KC_NO,   _______, KC_2TR,                 _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------|           |--------|
        // | LSHIFT            | W      | X      | C      | V      | B      | N      | ,?     | ;.     | :/     | !§     | RSHIFT                 |           | UP     |
        {   KC_T_(KC_NO),       KC_NO,   KC_NO,   FR_COLN, FR_EQL,  KC_NO,   FR_0,    FR_1,    FR_2,    FR_3,    FR_DOT,  KC_L_(KC_NO),               _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | LCTRL    | LCMD     | LALT     | SPACE                                                   | RALT     | RCMD     | FN       | RCTRL    |  | LFT    | DWN    | RGT    |
