...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_EXT] = {
        ...
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | CAPSLCK    | Q      | S      | D      | F      | G      | H      | J      | K      | L      | M      | ù%     | RETURN               |
        {   TT(L_NAV),   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_2TR,                   _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------|           |--------|
        // | LSHIFT        | W      | X      | C      | V      | B      | N      | ,?     | ;.     | :/     | !§     | RSHIFT                     |           | UP     |
    ...
    [L_SYM] = {
        ...
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | CAPSLCK    | Q      | S      | D      | F      | G      | H      | J      | K      | L      | M      | ù%     | RETURN               |
        {   _______,     FR_1,    FR_2,    FR_3,    FR_4,    FR_5,    FR_6,    FR_7,    FR_8,    FR_9,    FR_0,    FR_DLR,  KC_2TR,                   _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------|           |--------|
        // | LSHIFT        | W      | X      | C      | V      | B      | N      | ,?     | ;.     | :/     | !§     | RSHIFT                     |           | UP     |
    ...
    [L_NAV] = {
        ...
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | TAB       | A      | Z      | E      | R      | T      | Y      | U      | I      | O      | P      | ^¨     | $£     | *µ           |  | DEL    | END    | PGDN   |
        {   _______,    _______, _______, _______, KC_LALT, _______, KC_INS,  KC_HOME, KC_UP,   KC_END,  _______, _______, _______, _______,          _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | CAPSLCK    | Q      | S      | D      | F      | G      | H      | J      | K      | L      | M      | ù%     | RETURN               |
        {   _______,     _______, _______, KC_LCTL, KC_LSFT, _______, KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_2TR,                   _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------|           |--------|
        // | LSHIFT        | W      | X      | C      | V      | B      | N      | ,?     | ;.     | :/     | !§     | RSHIFT                     |           | UP     |
        {   KC_2TR,         _______, _______, _______, _______, _______, KC_BSPC, KC_BSPC, KC_ENT,  _______, _______, KC_2TR,                         _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | LCTRL    | LCMD     | LALT     | SPACE                                                   | RALT     | RCMD     | FN       | RCTRL    |  | LFT    | DWN    | RGT    |
        {   _______,   _______,   _______,   K_SPC(_______),                                           _______,   _______,   _______,   _______,      _______, _______, _______ }
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
