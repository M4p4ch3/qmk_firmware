...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_EXT] = {
        ...
        // |--------------------------------------------------------------------------------------------------------------------------------------|           |--------|
        // | LSHIFT        | W      | X      | C      | V      | B      | N      | ,?     | ;.     | :/     | !§     | RSHIFT                     |           | UP     |
        {   SFT_T(KC_CAPS), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_2TR,                         _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | LCTRL    | LCMD     | LALT     | SPACE                                                   | RALT     | RCMD     | FN       | RCTRL    |  | LFT    | DWN    | RGT    |
    ...
    [L_NAV] = {
        ...
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | TAB       | A      | Z      | E      | R      | T      | Y      | U      | I      | O      | P      | ^¨     | $£     | *µ           |  | DEL    | END    | PGDN   |
        {   _______,    KC_NO,   KC_LSFT, KC_LSFT, KC_INS,  KC_PGUP, KC_INS,  KC_HOME, KC_UP,   KC_END,  KC_NO,   KC_NO,   KC_NO,   KC_NO,            _______, _______, _______ },
        // |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
        // | CAPSLCK    | Q      | S      | D      | F      | G      | H      | J      | K      | L      | M      | ù%     | RETURN               |
